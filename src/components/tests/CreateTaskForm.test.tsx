...
async function fillForm(user: ReturnType<typeof userEvent.setup>) {
    await user.type(screen.getByLabelText(/title/i), VALID_FORM_DATA.title);
    await user.type(screen.getByLabelText(/description/i), VALID_FORM_DATA.description);
    await user.type(screen.getByLabelText(/metric/i), VALID_FORM_DATA.metric);

    const targetInput = screen.getByLabelText(/target progress/i);
    await user.clear(targetInput);
    await user.type(targetInput, VALID_FORM_DATA.targetProgress);
}
